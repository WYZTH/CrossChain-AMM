...
const approve = async() => {
    ...
    // Find gas limit
    let limit = await contractInstance.methods.approve(EthWrapperContract, web3.utils.toBN(approveAmount)).estimateGas({ from: account });
    // Call a function of the contract:
    return await contractInstance.methods.approve(EthWrapperContract, web3.utils.toBN(approveAmount)).send(
        {
            from: account,
            value: 0,
            gasLimit: limit + 5000,
